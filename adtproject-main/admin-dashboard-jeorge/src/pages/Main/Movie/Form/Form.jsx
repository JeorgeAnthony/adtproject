  ...
  const handleSearch = useCallback(() => {
    ...
    axios({
      ...
      headers: {
        ...
        Authorization:
          "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJlMWY0NDNmYjlhNDc3ZTMwMTAwYWUxZTljMGFhN2FiMCIsIm5iZiI6MTczMzMxODkxMi40Niwic3ViIjoiNjc1MDU5MDA2NTY3MDJhNzkyZmZiOThlIiwic2NvcGVzIjpbImFwaV9yZWFkIl0sInZlcnNpb24iOjF9.BxkC8zoDfrucdk6vPZa7PV0dc7M8dUwxVnRgFZLbzvE",
      },
    })
      .then((response) => {
